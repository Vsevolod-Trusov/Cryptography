...
namespace Lab_12
{
    public partial class Form1 : Form
    {
        ...
        string[,] redArr = new string[480, 640];
        string[,] greenArr = new string[480, 640];
        string[,] blueArr = new string[480, 640];
        int count = 0;
        ...
        private void openFile_Click(object sender, EventArgs e)
        {
            ...
            openFileDialog.InitialDirectory = @"D:\Univer\3курс\1semRP\POIT-3-kurs-2-sem\КМЗИ\Lab14\Lab14\Lab_12\bin\Debug";
            ...
            if (openFileDialog.ShowDialog() == DialogResult.OK)
            {
                ...
                Bitmap redBitmap = new Bitmap(480, 640);
                Bitmap greenBitmap = new Bitmap(480, 640);
                Bitmap blueBitmap = new Bitmap(480, 640);
                Bitmap colorBitmap = new Bitmap(480, 640);
                for (int y = 0; y < 640; y++)
                {
                    for (int x = 0; x < 480; x++)
                    {
        ...
        private void stegButton_Click(object sender, EventArgs e)
        {
            ...
            Bitmap resultBitmap = new Bitmap(480, 640);
            for (int y = 0; y < 640; y++)
            {
                for (int x = 0; x < 480; x++)
                {
